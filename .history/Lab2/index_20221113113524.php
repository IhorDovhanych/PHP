...
function validateFactoryData($data,$factory):bool {
    ...
    if (
        ...
        $data['staff'] == (string)$factory['employees_count'] &&
...
echo "<tr> <th>Id</th> <th>Title</th> <th>Staff number</th> <th>Branch</th> <th>Address</th> </tr>";
for($i = 0; $i < count($factory); $i++){
    echo "<tr>";
...
$arr = sortByemployees_countInBranch(5,70,"Bakery",$factory);
