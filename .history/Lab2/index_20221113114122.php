...
function saveDataInFile($data,$factories, $id){
    $dataStr = getUniqueId($factories, $id).' '.$data['title'].' '.$data['employees_count'].' '.$data['branch'].' '.$data['address']."\n";
...
function sortByEmployeesCountInBranch(int $x, int $y, string $branch, $arr) {
    $newArr = [];
...
$arr = sortByEmployeesCountInBranch(150,300,"chemistry",$factory);
